...
- **Status**: NOT WORKING - Infrastructure in place but not visually applied
- **Issue**: Font selection must happen during text shaping, but current architecture shapes all text with one font
- **Attempted**: Multiple approaches (see Failed Attempts section)
