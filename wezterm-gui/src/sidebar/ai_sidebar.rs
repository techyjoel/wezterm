...
pub struct AiSidebar {
    ...
    pub item_positions: HashMap<usize, crate::sidebar::position_cache::ItemPositionData>,
    coordinate_transform: crate::sidebar::position_cache::CoordinateTransform,

    // Track bounds for hit testing (non-activity items)
    pub suggestion_bounds: Option<euclid::Rect<f32, window::PixelUnit>>,
    pub goal_bounds: Option<euclid::Rect<f32, window::PixelUnit>>,
...
impl AiSidebar {
    ...
    pub fn new(config: SidebarConfig) -> Self {
        Self {
            ...
            activity_log_state: ActivityLogState::new(),
            activity_log_renderer: ActivityLogRenderer::new(),
    ...
    fn hit_test_item(
        ...
        match &position_tree.element_type {
            ElementType::CodeBlock { .. } => {
                ...
                TextSelectionManager::hit_test_text_positions(
    ...
    pub fn handle_filter_click(&mut self, filter: ActivityFilter) {
        if self.activity_filter != filter {
            ...
            self.activity_log_state.height_trackers.clear();
    ...
    pub fn set_scrollbar_bounds(&mut self, bounds: euclid::Rect<f32, window::PixelUnit>) {
        ...
        self.activity_log_state.activity_log_scrollbar_bounds = Some(bounds);
    }
...
impl Sidebar for AiSidebar {
    ...
    fn get_scrollbars(&self) -> super::SidebarScrollbars {
        ...
        super::SidebarScrollbars {
            activity_log: self.activity_log_state.activity_log_scrollbar.clone(),
